...
VALUES ('e576df51-cec4-44a2-b4c2-ebf25178ea8f', 0, N'49cc8d1e-5f64-4d20-9ef5-2096e725ade5', N'Admin@walurecapital.com', '2019-09-16T00:00:00.0000000', N'Admin@walurecapital.com', CAST(1 AS bit), NULL, 0, CAST(0 AS bit), NULL, CAST(0 AS bit), NULL, NULL, N'Admin@walurecapital.com', '2019-09-16T00:00:00.0000000', N'ADMIN@WALURECAPITAL.COM', N'ADMIN@WALURECAPITAL.COM', N'$2a$11$obt3v2C1G9HdxVO./WAqf.KgXjjvFWEbSffAPJgACiC3GmX73PqWS', N'08009300832', CAST(1 AS bit), NULL, N'536f8ac3-0df8-45d2-8f34-630d0a2ed6e6', CAST(0 AS bit), N'Admin@walurecapital.com', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AccessFailedCount', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'Email', N'EmailConfirmed', N'FirstName', N'Gender', N'IsDeleted', N'LastName', N'LockoutEnabled', N'LockoutEnd', N'MiddleName', N'ModifiedBy', N'ModifiedOn', N'NormalizedEmail', N'NormalizedUserName', N'PasswordHash', N'PhoneNumber', N'PhoneNumberConfirmed', N'RefreshToken', N'SecurityStamp', N'TwoFactorEnabled', N'UserName', N'UserType') AND [object_id] = OBJECT_ID(N'[WalureUser]'))
...
VALUES (N'20221119150603_init', N'7.0.0');
GO
