...
VALUES ('57240ef7-daba-4ce2-9224-34f5ea110f55', N'f3584a94-9423-4e1a-b949-0f95e6ad5682', NULL, '2019-09-16T00:00:00.0000000', CAST(0 AS bit), NULL, '2019-09-16T00:00:00.0000000', N'WALURE_ADMIN', N'WALURE_ADMIN'),
('5a30ac88-4cce-45e5-95c3-4f540b682402', N'3a941d9e-8805-450a-a2d7-ced838a13dd5', NULL, '2019-09-16T00:00:00.0000000', CAST(0 AS bit), NULL, '2019-09-16T00:00:00.0000000', N'WALURE_BASIC_USER', N'WALURE_BASIC_USER'),
('62ba02d3-fdc4-4a57-9db5-6608212f1106', N'988161f4-4b9c-4175-a6ab-3c5c42a6a920', NULL, '2019-09-16T00:00:00.0000000', CAST(1 AS bit), NULL, '2019-09-16T00:00:00.0000000', N'INBUILT_ADMIN', N'INBUILT_ADMIN');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'InBuilt', N'ModifiedBy', N'ModifiedOn', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[WalureRole]'))
...
VALUES ('9bf9c4ed-96dd-40b2-a63d-b0aed45f2848', 1, N'df7fb865-d00c-4b13-8f24-8016b6b7d669', N'Admin@walurecapital.com', '2019-09-16T00:00:00.0000000', N'Admin@walurecapital.com', CAST(0 AS bit), N'Admin', 0, CAST(0 AS bit), N'Admin', CAST(0 AS bit), NULL, NULL, N'Admin@walurecapital.com', '2019-09-16T00:00:00.0000000', N'ADMIN@WALURECAPITAL.COM', N'ADMIN@WALURECAPITAL.COM', N'$2a$11$hd.whzZe/WygWgA6mRQxPu3YyFiod9f4ZGp18XbOdL3PL.C24bxIC', N'08009300832', CAST(0 AS bit), NULL, N'c435d432-70ea-4aa5-ba3c-e89f81b7dfa6', CAST(0 AS bit), N'Admin@walurecapital.com', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AccessFailedCount', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'Email', N'EmailConfirmed', N'FirstName', N'Gender', N'IsDeleted', N'LastName', N'LockoutEnabled', N'LockoutEnd', N'MiddleName', N'ModifiedBy', N'ModifiedOn', N'NormalizedEmail', N'NormalizedUserName', N'PasswordHash', N'PhoneNumber', N'PhoneNumberConfirmed', N'RefreshToken', N'SecurityStamp', N'TwoFactorEnabled', N'UserName', N'UserType') AND [object_id] = OBJECT_ID(N'[WalureUser]'))
...
VALUES (N'20221121095954_int', N'7.0.0');
GO
