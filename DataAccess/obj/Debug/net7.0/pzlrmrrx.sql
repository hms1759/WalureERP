...
VALUES ('57240ef7-daba-4ce2-9224-34f5ea110f55', N'cefc8d1a-562f-46a9-9900-5b4c06b3324a', NULL, '2019-09-16T00:00:00.0000000', CAST(0 AS bit), NULL, '2019-09-16T00:00:00.0000000', N'WALURE_ADMIN', N'WALURE_ADMIN'),
('5a30ac88-4cce-45e5-95c3-4f540b682402', N'b225a8b7-0f55-4115-94be-5bd1b88e8e63', NULL, '2019-09-16T00:00:00.0000000', CAST(0 AS bit), NULL, '2019-09-16T00:00:00.0000000', N'WALURE_BASIC_USER', N'WALURE_BASIC_USER'),
('62ba02d3-fdc4-4a57-9db5-6608212f1106', N'8a35556f-68fb-4339-a3e5-70216b952195', NULL, '2019-09-16T00:00:00.0000000', CAST(1 AS bit), NULL, '2019-09-16T00:00:00.0000000', N'INBUILT_ADMIN', N'INBUILT_ADMIN');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'InBuilt', N'ModifiedBy', N'ModifiedOn', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[WalureRole]'))
...
VALUES ('9bf9c4ed-96dd-40b2-a63d-b0aed45f2848', 1, N'53e1b085-4350-45d7-8b52-33dce69743ca', N'Admin@walurecapital.com', '2019-09-16T00:00:00.0000000', N'Admin@walurecapital.com', CAST(0 AS bit), N'Admin', 0, CAST(0 AS bit), N'Admin', CAST(0 AS bit), NULL, NULL, N'Admin@walurecapital.com', '2019-09-16T00:00:00.0000000', N'ADMIN@WALURECAPITAL.COM', N'ADMIN@WALURECAPITAL.COM', N'$2a$11$wXih7IgHIIEL5lyqd56X2uNOCJ6vSXVFSD7W6EBuxxhqt/1GWHZoi', N'08009300832', CAST(0 AS bit), NULL, N'aca6c728-389f-424d-8e2e-a23e7afe69cd', CAST(0 AS bit), N'Admin@walurecapital.com', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AccessFailedCount', N'ConcurrencyStamp', N'CreatedBy', N'CreatedOn', N'Email', N'EmailConfirmed', N'FirstName', N'Gender', N'IsDeleted', N'LastName', N'LockoutEnabled', N'LockoutEnd', N'MiddleName', N'ModifiedBy', N'ModifiedOn', N'NormalizedEmail', N'NormalizedUserName', N'PasswordHash', N'PhoneNumber', N'PhoneNumberConfirmed', N'RefreshToken', N'SecurityStamp', N'TwoFactorEnabled', N'UserName', N'UserType') AND [object_id] = OBJECT_ID(N'[WalureUser]'))
...
VALUES (N'20221121101805_int', N'7.0.0');
GO
